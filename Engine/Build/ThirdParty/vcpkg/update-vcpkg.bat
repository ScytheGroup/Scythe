...
SETLOCAL
@REM SET VCPKG_LIST=curl:x64-windows-static rapidjson:x64-windows-static
SET VCPKG_LIST=assimp:x64-windows-static magic-enum:x64-windows-static nativefiledialog-extended:x64-windows-static
