...
:CompileShader
set shaderFile=%CompileShadersOutput%\%1_%3.inc
set shaderName=%1_%3.inc
...
if exist "%shaderFile%" (
    echo Shader file %shaderName% already exists, skipping compilation.
    exit /b
)
echo Compiling %shaderName%
%fxc% || set error=1
exit /b
